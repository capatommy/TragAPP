package com.example.tragapp.tragapp.uiutilities;
...
public class CardAdapter extends RecyclerView.Adapter<CardAdapter.CardViewHolder> {
    ...
    public CardAdapter(Context mContext,List<DataObject> data) {
        this.dataSet = data;
    ...
    public CardViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(mContext).inflate(R.layout.view_card_weather, parent, false);
